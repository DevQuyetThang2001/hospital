        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="card shadow-sm p-4">
                    ...
                    <form action="{{ route('receptionist.appointment.store', $doctor->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            <input type="text" value="Lễ tân đặt lịch" disabled name="notes" class="form-control" placeholder="Ghi chú (nếu có)">
                        </div>

                        <!-- Lễ tân đã đăng nhập, luôn hiện nút -->
