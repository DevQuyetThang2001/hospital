        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('admin.doctors.add') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('specialization') }}" name="specialization"
                                class="form-control" id="exampleInputPassword4" placeholder="Chuyên môn">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" value="{{ old('experience_years') }}" name="experience_years"
                                class="form-control" id="exampleInputPassword4" placeholder="Số năm hành nghề">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('license_number') }}" name="license_number"
                                class="form-control" id="exampleInputPassword4" placeholder="Chứng chỉ hành nghề">
