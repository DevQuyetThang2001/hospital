    ...
    <div class="col-lg-12 stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{route('admin.doctors.addDoctorForm')}}" class="btn btn-success uppercase text-md-end text-uppercase">Xác nhận</a>
          @if (session('success'))
              ...
              <tbody>
                @if(!empty($data))
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('admin.doctor.editDoctorForm', $item->id)}}" class="btn btn-secondary">
                              Sửa
                            </a>
                    ...
                    <div class="modal fade z-3" id="modal-{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                         <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{route('admin.doctors.delete',$item->id)}}" type="button" class="btn btn-primary">Đồng ý</a>
                            </div>
                            </div>
                         </div>
                        </div>
