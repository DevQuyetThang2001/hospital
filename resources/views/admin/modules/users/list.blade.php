    ...
    <div class="col-lg-12 stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{route('admin.users.addUserForm')}}" class="btn btn-success uppercase text-md-end text-uppercase">Thêm mới</a>
          @if (session('success'))
              ...
              <tbody>
                @if(!empty($data))
                    ...
                    <tr>
                        <td>
                          @if ($item->image)
                            <img style="width: 80px;height: 80px;object-fit: cover" src="{{asset('storage/'.$item->image)}}" alt="image">
                          @else
                        ...
                        <td>
                            ...
                            @if ($item->role === 'admin')
                            <button disabled type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-{{ $item->id }}">
                              Xóa
                            </button>
                            @else
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="{{route('admin.users.delete',$item->id)}}" type="button" class="btn btn-primary">Đồng ý</a>
                          </div>
                        </div>
                      </div>
                    </div>
