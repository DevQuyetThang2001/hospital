        ...
        <div class="card-body">
          ...
          <form class="forms-sample" action="{{route('admin.users.edit', $user->id)}}" method="POST"
            ...
            <div class="form-group">
              ...
              <input type="email" name="email" value="{{$user->email}}" class="form-control" id="exampleInputEmail3"
                placeholder="Email">
              @error('email')
                <div class="text-danger text-sm">{{$message}}</div>
              @enderror
            ...
            <div class="form-group">
              ...
              <select name="role" class="form-control" id="exampleSelectGender">
                ...
                <option {{$user->role === 'manager' ? 'selected' : ''}} value="schedule_manager">Quản lý</option>
