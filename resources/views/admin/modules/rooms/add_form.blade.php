    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" action="{{route('admin.rooms.addRoomEmptyDepartment')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <label for="exampleInputPassword4">Khoa viện</label>
                    <select name="department_id" class="form-control" id="exampleSelectGender">
                        <option value="">Chọn khoa viện</option>      
                        @foreach ($departmentsWithoutRooms as $item)
                ...
                <a href="{{route('admin.rooms.list')}}" class="btn text-light btn-warning mr-2">Trở về</a>
              </form>
            </div>
          </div>
    </div>
